  ...
  onload() {
    return __async(this, null, function* () {
      ...
      let settingsUpdate = () => {
        ...
        document.body.classList.toggle(
          "minimal-readable",
          this.settings.readableLineLength,
        );
        document.body.classList.toggle(
      ...
      const tableWidthStyles = [
        "table-100",
        "table-default-width",
        "table-wide",
        "table-max",
      ];
      const iframeWidthStyles = [
        "iframe-100",
      ...
      const mapWidthStyles = [
        "map-100",
        "map-default-width",
        "map-wide",
        "map-max",
      ];
      const chartWidthStyles = [
        "chart-100",
        "chart-default-width",
        "chart-wide",
        "chart-max",
      ...
      this.addCommand({
        ...
        callback: () => {
          this.settings.darkStyle =
            darkStyles[
              (darkStyles.indexOf(this.settings.darkStyle) + 1) %
                darkStyles.length
            ];
          this.saveData(this.settings);
          this.updateDarkStyle();
      ...
      this.addCommand({
        ...
        callback: () => {
          this.settings.lightStyle =
            lightStyles[
              (lightStyles.indexOf(this.settings.lightStyle) + 1) %
                lightStyles.length
            ];
          this.saveData(this.settings);
          this.updateLightStyle();
      ...
      this.addCommand({
        ...
        callback: () => {
          this.settings.tableWidth =
            tableWidthStyles[
              (tableWidthStyles.indexOf(this.settings.tableWidth) + 1) %
                tableWidthStyles.length
            ];
          this.saveData(this.settings);
          this.refresh();
        },
      ...
      this.addCommand({
        ...
        callback: () => {
          this.settings.imgWidth =
            imgWidthStyles[
              (imgWidthStyles.indexOf(this.settings.imgWidth) + 1) %
                imgWidthStyles.length
            ];
          this.saveData(this.settings);
          this.refresh();
        },
      ...
      this.addCommand({
        ...
        callback: () => {
          this.settings.iframeWidth =
            iframeWidthStyles[
              (iframeWidthStyles.indexOf(this.settings.iframeWidth) + 1) %
                iframeWidthStyles.length
            ];
          this.saveData(this.settings);
          this.refresh();
        },
      ...
      this.addCommand({
        ...
        callback: () => {
          this.settings.chartWidth =
            chartWidthStyles[
              (chartWidthStyles.indexOf(this.settings.chartWidth) + 1) %
                chartWidthStyles.length
            ];
          this.saveData(this.settings);
          this.refresh();
        },
      ...
      this.addCommand({
        ...
        callback: () => {
          this.settings.mapWidth =
            mapWidthStyles[
              (mapWidthStyles.indexOf(this.settings.mapWidth) + 1) %
                mapWidthStyles.length
            ];
          this.saveData(this.settings);
          this.refresh();
        },
      ...
      this.addCommand({
        ...
        callback: () => {
          this.settings.theme =
            theme[(theme.indexOf(this.settings.theme) + 1) % theme.length];
          this.saveData(this.settings);
          this.updateTheme();
        },
      });
...
var MinimalSettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    const featuresSection = containerEl.createEl("div", {
      cls: "setting-item setting-item-heading",
    });
    const featuresSectionInfo = featuresSection.createEl("div", {
      cls: "setting-item-info",
    });
    featuresSectionInfo.createEl("div", {
      text: "Features",
      cls: "setting-item-name",
    });
    const featuresSectionDesc = featuresSectionInfo.createEl("div", {
      cls: "setting-item-description",
    });
    ...
    new import_obsidian.Setting(containerEl)
      ...
      .addToggle((toggle) =>
        toggle.setValue(this.plugin.settings.labeledNav).onChange((value) => {
    ...
    new import_obsidian.Setting(containerEl)
      ...
      .addToggle((toggle) =>
        toggle.setValue(this.plugin.settings.trimNames).onChange((value) => {
    ...
    new import_obsidian.Setting(containerEl)
      ...
      .addToggle((toggle) =>
        toggle.setValue(this.plugin.settings.focusMode).onChange((value) => {
    ...
    containerEl.createEl("br");
    const layoutSection = containerEl.createEl("div", {
      cls: "setting-item setting-item-heading",
    });
    const layoutSectionInfo = layoutSection.createEl("div", {
      cls: "setting-item-info",
    });
    layoutSectionInfo.createEl("div", {
      text: "Layout",
      cls: "setting-item-name",
    });
    const layoutSectionDesc = layoutSectionInfo.createEl("div", {
      cls: "setting-item-description",
    });
    ...
    new import_obsidian.Setting(containerEl)
      ...
      .addToggle((toggle) =>
        toggle.setValue(this.plugin.settings.imgGrid).onChange((value) => {
