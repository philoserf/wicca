...
var FilenameHeadingSyncPlugin = /** @class */ (function (_super) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            this.addSettingTab(
              new FilenameHeadingSyncSettingTab(this.app, this),
            );
            this.addCommand({
              ...
              checkCallback: function (checking) {
                ...
                if (leaf) {
                  if (!checking) {
                    _this.settings.ignoredFiles[
                      _this.app.workspace.getActiveFile().path
                    ] = null;
                    _this.saveSettings();
                  }
                  return true;
  ...
  FilenameHeadingSyncPlugin.prototype.fileIsIgnored = function (
    activeFile,
    path,
  ) {
    // check exclusions
   ...
   */
  FilenameHeadingSyncPlugin.prototype.handleSyncHeadingToFile = function (
    file,
  ) {
  ...
  FilenameHeadingSyncPlugin.prototype.forceSyncHeadingToFilename = function (
    file,
  ) {
    var _this = this;
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              if (heading === null) return [2 /*return*/]; // no heading found, nothing to do here
   ...
   */
  FilenameHeadingSyncPlugin.prototype.handleSyncFilenameToHeading = function (
    file,
    oldPath,
  ) {
  ...
  FilenameHeadingSyncPlugin.prototype.forceSyncFilenameToHeading = function (
    file,
  ) {
    var _this = this;
    ...
    this.app.vault.read(file).then(function (data) {
      ...
      } else _this.insertHeading(file, lines, start, sanitizedHeading);
    });
  };
  /**
   ...
   */
  FilenameHeadingSyncPlugin.prototype.findHeading = function (
    fileLines,
    startLine,
  ) {
  ...
  FilenameHeadingSyncPlugin.prototype.sanitizeHeading = function (text) {
    ...
    var userIllegalSymbolsEscaped = this.settings.userIllegalSymbols.map(
      function (str) {
        return _this.regExpEscape(str);
      },
    );
    var userIllegalSymbolsRegExp = new RegExp(
   ...
   */
  FilenameHeadingSyncPlugin.prototype.insertHeading = function (
    file,
    fileLines,
    lineNumber,
    heading,
   ...
   * @param {string} text the new text
   */
  FilenameHeadingSyncPlugin.prototype.replaceHeading = function (
    file,
    fileLines,
    lineNumber,
    oldStyle,
   ...
   * @param {string} text the new text
   */
  FilenameHeadingSyncPlugin.prototype.replaceLineInFile = function (
    file,
    fileLines,
    lineNumber,
    text,
   ...
   */
  FilenameHeadingSyncPlugin.prototype.insertLineInFile = function (
    file,
    fileLines,
    lineNumber,
    text,
...
var FilenameHeadingSyncSettingTab = /** @class */ (function (_super) {
  ...
  FilenameHeadingSyncSettingTab.prototype.display = function () {
      ...
      try {
        ...
        files
          .filter(function (file) {
            return reg_1.exec(file.path) !== null;
          })
          .forEach(function (el) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
              return __generator(this, function (_a) {
                switch (_a.label) {
                  case 0:
                    if (value === "Prefix") {
                      this.plugin.settings.newHeadingStyle =
                        "Prefix" /* Prefix */;
                    }
                    if (value === "Underline") {
                      this.plugin.settings.newHeadingStyle =
    ...
    var _loop_1 = function (key) {
      var ignoredFilesSettingsObj = new obsidian.Setting(containerEl).setDesc(
        key,
      );
      ignoredFilesSettingsObj.addButton(function (button) {
        button.setButtonText("Delete").onClick(function () {
          return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                case 0:
